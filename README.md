...
Every entry is production-grade — actively maintained and deployed on real systems. Hobbyware, abandoned forks and proof-of-concept malware are left out by design.

- 📦 marks an entry available as an RPM and DEB package, installable in seconds on RHEL, Alma, Rocky, Amazon Linux, Fedora, Ubuntu, Debian and SLES.
